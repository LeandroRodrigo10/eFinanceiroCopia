...
namespace eFinanceiro.Controllers
{
    public class BanksController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("BankID,BankCode,BankName,RegistrationUserID,RegistrationDate,DesactivationUserID,DesactivationDate,IsActive")] Bank bank)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("BankID,BankCode,BankName,RegistrationUserID,RegistrationDate,DesactivationUserID,DesactivationDate,IsActive")] Bank bank)
        {
            if (id != bank.BankID)
            {
                return NotFound();
